...
export const StateSelector: React.FC = () => {
  ...
  const [selectedState, setSelectedState] = useState<StateData | null>(statesData.find(s => s.code === 'ca') || statesData[0]);
                ...
                <div className="solution-right-flex">
                  ...
                  <div className="dropdown-wrap" style={{ position: 'relative' }}>
                    ...
                    >
                      ...
                      <div className={`div-block-14 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}>
                    ...
                    {isOpen && (
                      <div className="dropdown-bottom" style={{ display: 'block', position: 'absolute', width: '100%', zIndex: 10 }}>
                        <div data-lenis-prevent="" className="dropdown-btn is-bottom" style={{ maxHeight: '300px', overflowY: 'auto' }}>
                          <div className="w-dyn-list">
                            <div role="list" className="state-dropdown-list w-dyn-items">
                                  ...
                                  <div className="products-flex">
                                    <div className="checkmark">
                                      <div className="solution-check is-dropdown">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 18 18" fill="none" className="check-svg">
                                          <path d="M3.5 10L7 13.3094L14.5 4" stroke="white" strokeWidth="2"></path>
                                        </svg>
                                      </div>
                                    </div>
                                    <div className="check-txt u-text-style-large">{state.name}</div>
                                  </div>
                                </div>
                              ))}
                            </div>
                ...
                <div>
                  <div className="w-dyn-list">
                    <div role="list" className="states-list w-dyn-items">
                      {statesData.map(state => {
                        const isActive = selectedState && selectedState.code === state.code;
                        return (
                          <div
                            key={state.code}
                          ...
                          >
                            <div className="states-top">
                              <div>
                                <div className="u-text-style-h4">{state.name}</div>
                              </div>
                            </div>
                            <div className="products-details-flex">
                              {state.products.map((prod, idx) => (
                                <div key={idx} className="products-flex">
                                  <div className="checkmark">
                                    <div className={`solution-check ${!prod.checked ? 'w-condition-invisible' : ''}`}>
                                      {prod.checked && (
                                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 18 18" fill="none" className="check-svg">
                                          <path d="M3.5 10L7 13.3094L14.5 4" stroke="white" strokeWidth="2"></path>
                                        </svg>
                                  ...
                                  <div className="check-txt u-text-style-large" dangerouslySetInnerHTML={{ __html: prod.name }}></div>
                                </div>
                              ))}
                            </div>
                          </div>
