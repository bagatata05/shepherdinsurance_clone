          ...
          <div className="u-content v-flex-8">
            <div className="content-flex v-flex-8">
              <h1 className="hero-heading u-text-style-h1">
                ...
                Insurance <span className="txt-icon-arrow is-up"> </span> for
                the builders and operators shaping{" "}
                <span className="txt-icon-arrow is-square"> </span> our <br />
            ...
            <div className="div-block-8">
              ...
              <div
                data-speed="50s"
                pause-on-hover="true"
                className="ticker-wrap is-offices is-home"
              >
                {/* Loop 1 */}
                <div className="ticker-contain">
                  <div className="ticker-coll-wrap is-offices w-dyn-list">
                    <div
                      role="list"
                      className="ticker-coll-list is-offices w-dyn-items"
                    >
                      {brokerLogos.map((logo, idx) => (
                        <div
                          key={`logo-1-${idx}`}
                          role="listitem"
                          className="ticker-coll-item is-offices w-dyn-item"
                        >
                          <img
                            src={logo.src}
                            alt={logo.alt}
