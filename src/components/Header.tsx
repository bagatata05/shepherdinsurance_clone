...
export const Header: React.FC<HeaderProps> = ({ theme = "brand" }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        className={`nav_component w-variant-dd866659-1d7d-6447-6461-66ca86ca367f ${theme === "brand" ? "u-theme-brand" : "u-theme-light"}`}
        ...
        {bannerVisible && (
          ...
          >
            <div className="nav_banner_contain">
              <Link
                href="/blog/behind-our-42m-series-b"
                className="nav_banner_link w-inline-block"
              >
              ...
              >
                ...
                <span className="nav_screen-reader-text">
        ...
        <header className="nav_desktop_wrap">
          <div className="nav_desktop_contain">
            <div className="nav_desktop_layout">
              <Link
                href="/"
                className="nav_desktop_logo w-inline-block w--current"
              >
              ...
              <nav
                aria-label="Main"
                data-wf--menu--variant="desktop"
                className="nav_links_component w-variant-23049969-09ac-2789-520b-3c6ae895bbc6"
              >
                <ul
                  role="list"
                  className="nav_links_wrap w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-list-unstyled"
                >
                  {/* Products Dropdown */}
                  <li
                    ...
                    <div className="nav_dropdown_component w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-dropdown">
                      ...
                      >
                        <Link href="/products" className="w-inline-block">
                          <div className="nav_links_text u-text-style-small">
                            PRODUCTS
                          </div>
                        </Link>
                      ...
                      <nav
                        className={`nav_dropdown_mega_wrap w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-dropdown-list ${activeDropdown === "products" ? "w--open" : ""}`}
                      >
                        <div className="nav_dropdown_mega_content w-variant-23049969-09ac-2789-520b-3c6ae895bbc6">
                          <div
                            data-lenis-prevent=""
                            className="nav_dropdown_mega_scroll"
                          >
                              ...
                              <div className="nav_dropdown_mega_layout w-variant-23049969-09ac-2789-520b-3c6ae895bbc6">
                                <ul role="list" className="nav_dropdown_list">
                                  <li className="nav_dropdown_item">
                                    <Link
                                      href="/products"
                                      className="nav_dropdown_link w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-inline-block"
                                    >
                                      <div className="nav_links_text u-text-style-small">
                                        Overview
                                      </div>
                  ...
                  >
                    <div className="nav_dropdown_component w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-dropdown">
                      ...
                      <nav
                        className={`nav_dropdown_mega_wrap w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-dropdown-list ${activeDropdown === "industries" ? "w--open" : ""}`}
                      >
                        <div className="nav_dropdown_mega_content w-variant-23049969-09ac-2789-520b-3c6ae895bbc6">
                          <div
                            data-lenis-prevent=""
                  ...
                  >
                    <div className="nav_dropdown_component w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-dropdown">
                      ...
                      <nav
                        className={`nav_dropdown_mega_wrap w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-dropdown-list ${activeDropdown === "resources" ? "w--open" : ""}`}
                      >
                        <div className="nav_dropdown_mega_content w-variant-23049969-09ac-2789-520b-3c6ae895bbc6">
                          <div
                            data-lenis-prevent=""
                ...
                <ul
                  role="list"
                  className="nav_actions_wrap w-variant-23049969-09ac-2789-520b-3c6ae895bbc6 w-list-unstyled"
                >
