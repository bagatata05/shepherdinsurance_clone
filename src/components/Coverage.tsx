                  ...
                  <div className="split-card-content-flex is-large">
                    ...
                    <div className="split-card-content-btn-flex v-flex-6">
                      <div className="u-text-style-main">
                        Where speed, intelligence, and human judgment work
                        together to build a risk management platform for the
                        modern era.
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="cta-card-wrap">
                          ...
                          >
                            ...
                            <div className="solution-top-left">
                              <div className="split-card-content-flex is-large">
                                <div>
                                  <div className="solution-top-txt u-text-style-large">
                                    {card.title}
                                  </div>
                                </div>
                              </div>
