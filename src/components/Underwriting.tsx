            ...
            <div className="content-flex v-flex-8">
                ...
                <div className="section-header-grid u-grid-custom">
                  ...
                  <div>
                    <div className="u-text-style-main">
                      We provide financial services for the companies that build the world — and keep it running.
                    </div>
                  </div>
                </div>
              ...
              <div className="section-content-flex v-flex-5">
                <div className="section-header-grid u-grid-custom">
                  ...
                  <div>
                    <div className="u-text-style-main">
                      We're modernizing insurance from the ground up to get faster decisions and clearer risk insights.
                    </div>
                  </div>
                </div>
                ...
                <div className="card-grid-3 u-grid-custom">
                  ...
                  {/* Card 1 */}
                  <div data-wf--centered-card--variant="base" className="centered-card-slide">
                    <div className="centered-card-wrap">
                      <div className="centered-card-content-abs">
                        <div className="div-block">
                          <div className="div-block-2">
                            <img src="/assets/gifs/speed-keeps-pace.gif" loading="lazy" alt="Speed" className="img-abs" />
                          </div>
                        </div>
                        <div className="u-text-style-large">Speed that keeps pace</div>
                        <div>Underwriting decisions in hours, not weeks. Automation and AI streamline complexity.</div>
                      </div>
                  ...
                  <div data-wf--centered-card--variant="base" className="centered-card-slide">
                    <div className="centered-card-wrap">
                      <div className="centered-card-content-abs">
                        <div className="div-block">
                          <div className="div-block-2">
                            <img src="/assets/gifs/intelligence-rewards.gif" loading="lazy" alt="Intelligence" className="img-abs" />
                          </div>
                        </div>
                        <div className="u-text-style-large">Intelligence that rewards</div>
                        <div>Pricing which proactively rewards the behaviors that drive better outcomes.</div>
                      </div>
                      <CornerSvg className="corner-svg" />
                    </div>
                    <div className="div-block-21">
                  ...
                  <div data-wf--centered-card--variant="base" className="centered-card-slide">
                    <div className="centered-card-wrap">
                      <div className="centered-card-content-abs">
                        <div className="div-block">
                          <div className="div-block-2">
                            <img src="/assets/gifs/single-connected-system.gif" loading="lazy" alt="Connected System" className="img-abs" />
                          </div>
                        </div>
                        <div className="u-text-style-large">A single connected system</div>
                        <div>Unified product suite designed to provide a one-stop solution for clients.</div>
                      </div>
                      <CornerSvg className="corner-svg" />
                    </div>
                    <div className="div-block-21">
