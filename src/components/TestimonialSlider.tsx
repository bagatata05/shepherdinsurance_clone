...
export function TestimonialSlider({ testimonials, staticImage, staticImageSrcSet }: TestimonialSliderProps) {
  ...
  return (
    <div className="split-card u-grid-custom u-theme-beige is-testimonials">
      <div className="div-block-10" style={{ overflow: 'hidden', position: 'relative' }}>
        <div 
        ...
        >
          <div 
            style={{ "--lg": "1", "--md": "1", "--sm": "1", "--xs": "1" } as React.CSSProperties} 
                  ...
                  >
                    <div className="div-block-11">
                      <div className="testimonial-top-flex v-flex-4">
                        <div className="testimonial-title u-text-style-h3">{testimonial.title}</div>
                        <div className="u-text-style-main">{testimonial.quote}</div>
                      </div>
                      <div className="testimonial-botton-flex">
                        <div className="testimonial-bottom">
                          {testimonial.authorImg && (
                            <img src={testimonial.authorImg} loading="lazy" alt="" className="testimonial-img" />
                          )}
                          {testimonial.authorInfo && (
                            <div className="u-text-style-small">{testimonial.authorInfo}</div>
                          )}
                        </div>
                        <div>
                          <div data-wf--button-main--variant="primary" className="button_main_wrap" data-button="" data-trigger="hover-focus">
                            <div className="clickable_wrap u-cover-absolute">
                              <Link href={testimonial.btnLink} className="clickable_link w-inline-block">
                                <span className="clickable_text u-sr-only">READ MORE</span>
                              </Link>
                            ...
                            <div className="button_main_element">
                              ...
                              <div aria-hidden="true" className="button_main_text u-text-style-small">READ MORE</div>
        ...
        <div className="slider_controls w-variant-bfb8c45c-dbfa-13cc-2dfc-0c02a34504e4">
          <div className="slider_button_layout">
            ...
            >
              <div className="button_arrow_element">
                <div aria-hidden="true" className="button_arrow_icon">
                  <svg data-wf--icon-arrow-full--variant="left" xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 33 26" fill="none" aria-hidden="true" className="u-svg w-variant-1c3f028b-116e-d4eb-db7f-8484491bbf2e">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 10 10" fill="none">
                      <path d="M0 8.28L7.53998 5.14L0 1.56V0L9.41998 4.7V5.7L0 9.84V8.28Z" fill="currentColor"></path>
                    </svg>
                  </svg>
                </div>
              </div>
              <div className="clickable_wrap u-cover-absolute">
                <a href="#" className="clickable_link w-inline-block" onClick={(e) => e.preventDefault()}>
            ...
            <div className="slider-count-txt u-text-style-large">
              <span>{activeSlide + 1}</span> OF <span>{testimonials.length}</span>
            </div>
            ...
            >
              <div className="button_arrow_element">
                <div aria-hidden="true" className="button_arrow_icon">
                  <svg data-wf--icon-arrow-full--variant="right" xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 33 26" fill="none" aria-hidden="true" className="u-svg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 10 10" fill="none">
                      <path d="M0 8.28L7.53998 5.14L0 1.56V0L9.41998 4.7V5.7L0 9.84V8.28Z" fill="currentColor"></path>
                    </svg>
                  </svg>
