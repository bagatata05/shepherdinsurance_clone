...
export const AppetiteSection: React.FC = () => {
  ...
  const handleSelect = (
    product: "primary" | "excess" | "builders",
  ) => {
                  ...
                  <div className="appetite-details-wrap-flex">
                    ...
                    {activeProduct === "builders" && (
                      <ProductPanel
                        ...
                        activeAccordion={activeAccordion}
                        onToggleAccordion={handleToggleAccordion}
                        targetItems={targetAppetiteBuilders}
                        restrictedItems={restrictedBuilders}
                        partnershipItems={partnershipsBuilders}
                      />
                    )}
                  </div>
                </div>
