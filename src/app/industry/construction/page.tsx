            ...
            <div className="pages-hero-grid u-grid-custom">
                        ...
                        <div className="content-flex v-flex-8 u-justify-content-between">
                          <div className="pages-heading-flex v-flex-6">
                            ...
                            <div className="hero-p u-text-style-main">
                              For the builders and developers delivering
              ...
              <div className="hero-grid-visual">
                <div id="careers-video" className="u-visual">
                  <img
                    src="/assets/images/rectangle-195.avif"
                    loading="lazy"
                    alt=""
                    sizes="(max-width: 1360px) 100vw, 1360px"
                    srcSet="/assets/images/rectangle-195-p-500.avif 500w, /assets/images/rectangle-195-p-800.avif 800w, /assets/images/rectangle-195-p-1080.avif 1080w, /assets/images/rectangle-195.avif 1440w"
                  ...
                  <div className="content-flex v-flex-8">
                    <div className="products-overview-grid u-grid-custom">
                      <div className="solution-right-flex">
                        ...
                        <div
                          className="dropdown-wrap is-appetite"
                          ref={dropdownRef}
                          style={{ position: "relative" }}
                        >
                          <button
                            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                            className="dropdown-btn is-top"
                            type="button"
                          >
                            <div
                                ...
                                <div className="state-dropdown-list">
                                  ...
                                  >
                                    <div className="products-flex">
                                      <div className="checkmark">
                                        <div
                                          className={`solution-check is-dropdown ${activeProduct === "builders" ? "is-active" : "w-condition-invisible"}`}
                                        >
                                          <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="100%"
                      ...
                      <div className="appetite-right">
                        <div className="appetite-details-wrap-flex">
                                    ...
                                    >
                                      <div className="accordion_content_padding">
                                        <div className="appetite-details-flex">
                                          {[
                                            "Commercial",
                                            "Countrywide (excluding NY)",
                                            "General Contractors, Construction Managers, Specialty Trade Contractors",
                                            "Multi-Year Wrap-Up Programs: OCIPs & CCIPs Project-Specific JV Programs.",
                                            "Maintenance Wrap-Ups",
                                            "Owner's Interest",
                                            "Minimum Annual Revenues ~$25M",
                                          ].map((item, idx) => (
                                            <div
                                              key={idx}
                          ...
                          <div
                            ...
                            style={{
                              display:
                                activeProduct === "builders" ? "flex" : "none",
                            }}
                          >
                            <div className="appetite-details-title">
                              Builder&apos;s Risk
                  ...
                  <div className="product-large-img-wrap">
                    ...
                    <div id="careers-video" className="u-visual">
                      <img
                        ...
                        alt=""
                        sizes="(max-width: 1360px) 100vw, 1360px"
                        srcSet="/assets/images/rectangle-149481041-p-500.webp 500w, /assets/images/rectangle-149481041-p-800.webp 800w, /assets/images/rectangle-149481041-p-1080.webp 1080w, /assets/images/rectangle-149481041-p-1600.webp 1600w, /assets/images/rectangle-149481041-p-2000.webp 2000w, /assets/images/rectangle-149481041.webp 2040w"
                        className="u-visual-image"
                      />
                      <div className="u-visual-bk"></div>
                      <div className="img-overlay"></div>
                      ...
                      <div className="content-flex v-flex-6">
                        ...
                        <div className="scroll-dropdown-flex">
                          <div className="scroll-dropdown-item">
                            <div className="scroll-dropdown-top">
                              <div className="scroll-dropdown-top-text u-text-style-h4">
                                How partnership and trust are driving
                                Shepherd&apos;s Primary Practice expansion
                              </div>
                            </div>
                                ...
                                <div className="scroll-dropdown-bottom-video-col u-column-span-2">
                                  <div>
                                    ...
                                    >
                                      ...
                                      >
                                        <img
                                          src="/assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1.webp"
                                          loading="lazy"
                                          alt=""
                                          sizes="(max-width: 1360px) 100vw, 1360px"
                                          srcSet="/assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1-p-500.webp 500w, /assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1-p-800.webp 800w, /assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1-p-1080.webp 1080w, /assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1-p-1600.webp 1600w, /assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1-p-2000.webp 2000w, /assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1-p-2600.webp 2600w, /assets/images/vitalii-khodzinskyi-5hobvrtu0cc-unsplash-1.webp 2731w"
                                          className="u-visual-image"
                                        />
                                        <div className="u-visual-bk"></div>
                                        <div className="img-overlay"></div>
                          ...
                          <div className="scroll-dropdown-item">
                            <div className="scroll-dropdown-top">
                              <div className="scroll-dropdown-top-text u-text-style-h4">
                                Shepherd grows Primary Practice portfolio with
                                high-touch approach
                              </div>
                            </div>
                            <div className="scroll-dropdown-bottom-wrap">
                              <div className="scroll-dropdown-bottom-grid u-grid-custom">
                                <div className="scroll-dropdown-bottom-video-col u-column-span-2">
                                  <div>
                                    ...
                                    >
                                      ...
                                      >
                                        <img
                                          src="/assets/images/getty-images-t6-lv4nf0zy-unsplash-1.webp"
                                          loading="lazy"
                                          alt=""
                                          sizes="(max-width: 1360px) 100vw, 1360px"
                                          srcSet="/assets/images/getty-images-t6-lv4nf0zy-unsplash-1-p-500.webp 500w, /assets/images/getty-images-t6-lv4nf0zy-unsplash-1-p-800.webp 800w, /assets/images/getty-images-t6-lv4nf0zy-unsplash-1-p-1080.webp 1080w, /assets/images/getty-images-t6-lv4nf0zy-unsplash-1-p-1600.webp 1600w, /assets/images/getty-images-t6-lv4nf0zy-unsplash-1.webp 1920w"
                                          className="u-visual-image"
                                        />
                                        <div className="u-visual-bk"></div>
                                        <div className="img-overlay"></div>
                                ...
                                <div className="scroll-dropdown-bottom-content">
                                  <div className="u-text-style-main">
                                    &quot;Shepherd was really easy to work
                                    with—responsive and accommodating to all of
                                    our requests. Since our team has a strong
                                    focus on coverages, particularly to meet the
                                    contractual obligations of our insureds, we
                                    appreciated that every request we made
                                    regarding coverage was carefully considered
                                    and approved.&quot;
                                    <br />
                                    <br />
                                    Leah Esponge
                                  ...
                                  <div>
                                    ...
                                    >
                                      <div className="clickable_wrap u-cover-absolute">
                                        <a
                                          href="/case-studies/shepherd-s-high-touch-approach-fuels-primary-practice-growth"
                                          className="clickable_link w-inline-block"
                                        >
                                          <span className="clickable_text u-sr-only">
                                            READ MORE
                                ...
                                <div className="scroll-dropdown-bottom-video-col u-column-span-2">
                                  <div>
                                    ...
                                    >
                                      ...
                                      >
                                        <img
                                          src="/assets/images/getty-images-h0k1aqzf7ay-unsplash-1.webp"
                                          loading="lazy"
                                          alt=""
                                          sizes="(max-width: 1360px) 100vw, 1360px"
                                          srcSet="/assets/images/getty-images-h0k1aqzf7ay-unsplash-1-p-500.webp 500w, /assets/images/getty-images-h0k1aqzf7ay-unsplash-1-p-800.webp 800w, /assets/images/getty-images-h0k1aqzf7ay-unsplash-1-p-1080.webp 1080w, /assets/images/getty-images-h0k1aqzf7ay-unsplash-1-p-1600.webp 1600w, /assets/images/getty-images-h0k1aqzf7ay-unsplash-1.webp 1920w"
                                          className="u-visual-image"
                                        />
                                        <div className="u-visual-bk"></div>
                                        <div className="img-overlay"></div>
