...
import { RenewableHero } from "./components/RenewableHero";
import { AppetiteSection } from "./components/AppetiteSection";
    ...
    <div ref={mainRef} id="main" className="page_wrap">
      <div data-barba="container" className="page_main">
        ...
        <div className="industries-page-content">
          ...
          <DurabilitySection
            theme="light"
            heading="Insurance solutions built for a changing world."
            description="We&apos;re modernizing insurance from the ground up to get faster decisions and clearer risk insights."
          />
          <AppetiteSection />
          <SavingsPromo />
          <ScrollDropdowns />
          ...
          <CTA
            ...
            description="Learn more about how Shepherd can work with you."
          />
        </div>
